...
- **Topic-Aware Content & Coding Assessment Generation**: Upgraded the seeder to inspect course title and module titles, generating realistic lesson HTML templates (detailed explanations, custom diagrams, code walkthroughs) and fully functional coding challenges (e.g. converters, sum loops, prompt parsing) matching the actual curriculum topics.
