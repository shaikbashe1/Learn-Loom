...
export default function AdminCoursesPage() {
  ...
  const handleAIGenerate = async (e: React.FormEvent) => {
    ...
    setForm({
      ...
      description: `This is a comprehensive course about ${aiPrompt}, generated by AI. It covers all the essential topics from beginner to advanced concepts.`,
      difficulty: 'Beginner',
      youtube_url: '',
      notes_url: '',
    });
    setModules([
      { title: 'Introduction', description: `Overview of ${aiPrompt}`, content_url: '', notes_url: '', order_index: 0, duration_minutes: 30, type: 'video', is_free_preview: true },
      { title: 'Core Concepts', description: `Deep dive into the main concepts`, content_url: '', notes_url: '', order_index: 1, duration_minutes: 45, type: 'video', is_free_preview: false },
      { title: 'Advanced Topics', description: `Mastering advanced patterns`, content_url: '', notes_url: '', order_index: 2, duration_minutes: 60, type: 'video', is_free_preview: false },
    ]);
    setAssignment({ title: `Final Project: ${aiPrompt}`, instructions: `Build a complete project applying what you learned about ${aiPrompt}.`, due_days: 7 });
    setQuiz({ title: `Knowledge Check: ${aiPrompt}` });
    setQuestions([
      { question: `What is the primary purpose of ${aiPrompt}?`, options: ['Option A', 'Option B', 'Option C', 'Option D'], answer_index: 0 },
      { question: `Which of the following is a key feature?`, options: ['Feature 1', 'Feature 2', 'Feature 3', 'Feature 4'], answer_index: 1 },
    ]);
